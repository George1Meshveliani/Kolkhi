        ...
        <Fade duration={1000}>
          <div >
            ...
            <div className="nine columns main-col">
              ...
              კონსტიტუციაში ჩაიწერება რომ არ შეიძლება ადამიანის 
              შემოსავალი (ხელფასი, პენსია, სოციალური დახმარება) არ შეიძლება იყოს 
              საარსებო მინიმუმზე ნაკლები. ასევე ჩაიწერება,
              რომ სახელმწიფო ბიუჯეტიდან მიღებული ანაზღაურება არ შეიძლება იყოს განსაზღვრულ ზღვარზე მეტი. 

              არსებული საკრედიტო ვალდებულებისგან მოსახელობის სრულ 
              გათავისუფლება, საბანკო მონოპოლიის და დიქტატურის დამხობა. 
              ...
              მათ ადგილზე ხუთი წლის ვადით უცხოელი იურისტების 
              დანიშვნა, რომლებიც მკაცრად მხოლოდ კანონით იხელმძღვანელებენ და
               უზრუნველყოფენ თავისუფალი სასამართლოს მუშაობას. 
